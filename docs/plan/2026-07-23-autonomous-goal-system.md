...
- 작성일: 2026-07-23
- 상태: 승인됨 (PR1–PR2 커밋, PR3 리뷰·커밋 직전)
...
3. Runner v2 slice OPAVR + partial (**리뷰 직전**)
4. research_mode + cost/events
5. worktree + optional parallel

Flag: `goal_runner_v2` — PR3에서는 SlicePlan 상시 사용(단일 fallback 포함)으로 도입. 별도 off 스위치는 필요 시 PR4+.
...
- 2026-07-24: PR3 구현 — selectActiveGoalSlice, slice-scoped implement/semantic, multi-slice continue, partial delivery on block.
