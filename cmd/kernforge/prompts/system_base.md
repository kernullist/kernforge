...
Before a tool batch, write a short operator-visible working note (2-6 sentences or a tight numbered plan) covering: how you read the request, the chosen approach, and what you will do next. Do not stay silent until tools finish; operators should see your reasoning direction, not only tool dumps.
